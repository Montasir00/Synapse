            ...
            <div className="relative flex-1 overflow-y-auto scrollbar-custom p-6 sm:p-10">
              ...
              <form className="space-y-10" onSubmit={handleSubmit}>
                ...
                <div className="space-y-4">
                  <p className="text-xs font-black text-muted/75 uppercase tracking-[0.2em] px-1">Engagement Framework</p>
                  ...
                  {taskCategory === 'long-term' ? (
                    ...
                    >
                      <div className="flex items-center justify-between px-1">
                        <label className="text-xs font-black text-muted/75 uppercase tracking-[0.2em]">Project Checkpoints</label>
                      ...
                      <div className="flex gap-2">
                        <input 
                          ...
                          className="flex-1 bg-surface/50 rounded-2xl py-3.5 px-6 text-xs font-bold focus:border-accent/40 outline-none transition-all border border-border text-ink placeholder:text-muted/60 uppercase tracking-widest"
                ...
                {/* Notes */}
                <div className="space-y-3">
                  <label htmlFor="task-notes" className="text-xs font-black text-muted/75 uppercase tracking-[0.2em] px-1">Supplemental Logic</label>
                  <div className="relative group">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-surface-subtle/50 rounded-[28px] py-4 pl-12 pr-5 text-xs font-bold focus:border-accent/40 outline-none transition-all min-h-[120px] resize-none border border-border text-ink placeholder:text-muted/60 uppercase tracking-widest"
                    />
                  </div>
                </div>
